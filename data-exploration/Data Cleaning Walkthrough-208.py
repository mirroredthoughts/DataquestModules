...
data['hs_directory']["lat"]=data['hs_directory']['Location 1'].apply(strmatch)
...
data['hs_directory']["lon"]=data['hs_directory']['Location 1'].apply(strmatch)
